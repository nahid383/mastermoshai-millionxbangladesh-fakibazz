...
export const sampleQuestions: Question[] = [
  ...
  // More Cell Biology Questions
  {
    id: 'q-bio-cell-3',
    subjectId: 'biology',
    topicId: 'cell',
    question: 'What is the function of the cell membrane?',
    questionBn: 'কোষ ঝিল্লির কাজ কী?',
    options: ['Energy production', 'Protein synthesis', 'Controls what enters and leaves the cell', 'Stores genetic material'],
    optionsBn: ['শক্তি উৎপাদন', 'প্রোটিন সংশ্লেষণ', 'কোষে কী প্রবেশ করে এবং বের হয় তা নিয়ন্ত্রণ করে', 'জেনেটিক উপাদান সঞ্চয় করে'],
    correctAnswer: 2,
    explanation: 'The cell membrane is selectively permeable and controls the movement of substances in and out of the cell.',
    explanationBn: 'কোষ ঝিল্লি নির্বাচনীভাবে প্রবেশযোগ্য এবং কোষে পদার্থের গতিবিধি নিয়ন্ত্রণ করে।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'কোন কোষ অঙ্গাণুতে পাচক এনজাইম থাকে?',
    options: ['Mitochondria', 'Lysosome', 'Ribosome', 'Golgi body'],
    optionsBn: ['মাইটোকন্ড্রিয়া', 'লাইসোসোম', 'রাইবোসোম', 'গলগি বডি'],
    correctAnswer: 1,
    explanation: 'Lysosomes contain digestive enzymes that break down waste materials and cellular debris.',
    explanationBn: 'লাইসোসোমে পাচক এনজাইম থাকে যা বর্জ্য পদার্থ এবং কোষীয় ধ্বংসাবশেষ ভেঙে ফেলে।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'প্রোক্যারিওটিক এবং ইউক্যারিওটিক কোষের মধ্যে পার্থক্য কী?',
    options: ['Size only', 'Prokaryotes lack a nucleus', 'Eukaryotes lack a nucleus', 'No difference'],
    optionsBn: ['শুধু আকার', 'প্রোক্যারিওটে নিউক্লিয়াস নেই', 'ইউক্যারিওটে নিউক্লিয়াস নেই', 'কোন পার্থক্য নেই'],
    correctAnswer: 1,
    explanation: 'Prokaryotic cells lack a membrane-bound nucleus, while eukaryotic cells have one.',
    explanationBn: 'প্রোক্যারিওটিক কোষে ঝিল্লি-আবদ্ধ নিউক্লিয়াস নেই, যখন ইউক্যারিওটিক কোষে আছে।',
    difficulty: 'medium',
    points: 15,
  },
  {
    ...
    questionBn: 'কোন অঙ্গাণু শুধুমাত্র উদ্ভিদ কোষে পাওয়া যায়?',
    options: ['Mitochondria', 'Nucleus', 'Chloroplast', 'Ribosome'],
    optionsBn: ['মাইটোকন্ড্রিয়া', 'নিউক্লিয়াস', 'ক্লোরোপ্লাস্ট', 'রাইবোসোম'],
    correctAnswer: 2,
    explanation: 'Chloroplasts are found only in plant cells and are the site of photosynthesis.',
    explanationBn: 'ক্লোরোপ্লাস্ট শুধুমাত্র উদ্ভিদ কোষে পাওয়া যায় এবং সালোকসংশ্লেষণের স্থান।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'এন্ডোপ্লাজমিক রেটিকুলামের কাজ কী?',
    options: ['Energy production', 'Transport of materials', 'DNA storage', 'Cell division'],
    optionsBn: ['শক্তি উৎপাদন', 'পদার্থ পরিবহন', 'DNA সঞ্চয়', 'কোষ বিভাজন'],
    correctAnswer: 1,
    explanation: 'The ER is involved in the transport of materials within the cell.',
    explanationBn: 'ER কোষের মধ্যে পদার্থ পরিবহনে জড়িত।',
    difficulty: 'easy',
    points: 10,
  },
  ...
  // More Algebra Questions
  {
    ...
    subjectId: 'math',
    topicId: 'algebra',
    question: 'What is the value of (a+b)² when a=2 and b=3?',
    questionBn: 'a=2 এবং b=3 হলে (a+b)² এর মান কত?',
    options: ['13', '25', '10', '36'],
    optionsBn: ['১৩', '২৫', '১০', '৩৬'],
    correctAnswer: 1,
    explanation: '(2+3)² = 5² = 25',
    explanationBn: '(২+৩)² = ৫² = ২৫',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'সমাধান করুন: 3(x-2) = 12',
    options: ['x = 2', 'x = 4', 'x = 6', 'x = 8'],
    optionsBn: ['x = ২', 'x = ৪', 'x = ৬', 'x = ৮'],
    correctAnswer: 2,
    explanation: '3(x-2) = 12 → x-2 = 4 → x = 6',
    explanationBn: '3(x-2) = 12 → x-2 = 4 → x = ৬',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'x² - 9 এর উৎপাদকে বিশ্লেষণ কী?',
    options: ['(x-3)(x-3)', '(x+3)(x-3)', '(x+9)(x-1)', '(x-1)(x+9)'],
    correctAnswer: 1,
    explanation: 'x² - 9 = (x+3)(x-3) using difference of squares.',
    explanationBn: 'x² - 9 = (x+3)(x-3) বর্গের পার্থক্য ব্যবহার করে।',
    difficulty: 'medium',
    points: 15,
  },
  {
    ...
    questionBn: 'যদি 2x + 3y = 12 এবং x = 3 হয়, তাহলে y কত?',
    options: ['1', '2', '3', '4'],
    optionsBn: ['১', '২', '৩', '৪'],
    correctAnswer: 1,
    explanation: '2(3) + 3y = 12 → 6 + 3y = 12 → 3y = 6 → y = 2',
    explanationBn: '2(3) + 3y = 12 → 6 + 3y = 12 → 3y = 6 → y = ২',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: '3x⁴ + 2x² - x + 5 বহুপদীর মাত্রা কত?',
    options: ['2', '3', '4', '5'],
    optionsBn: ['২', '৩', '৪', '৫'],
    correctAnswer: 2,
    explanation: 'The degree is the highest power of x, which is 4.',
    explanationBn: 'মাত্রা হল x এর সর্বোচ্চ ঘাত, যা ৪।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'সরলীকরণ করুন: (x³)(x²)',
    options: ['x⁵', 'x⁶', 'x¹', '2x⁵'],
    correctAnswer: 0,
    explanation: 'When multiplying like bases, add exponents: x³ × x² = x⁵',
    explanationBn: 'সমান ভিত্তি গুণ করার সময়, সূচক যোগ করুন: x³ × x² = x⁵',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: '√১৪৪ কত?',
    options: ['10', '11', '12', '14'],
    optionsBn: ['১০', '১১', '১২', '১৪'],
    correctAnswer: 2,
    explanation: '√144 = 12 because 12 × 12 = 144',
    explanationBn: '√১৪৪ = ১২ কারণ ১২ × ১২ = ১৪৪',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    subjectId: 'math',
    topicId: 'algebra',
    question: 'Find x if x/4 = 8',
    questionBn: 'x/4 = 8 হলে x এর মান বের করুন',
    options: ['2', '12', '24', '32'],
    optionsBn: ['২', '১২', '২৪', '৩২'],
    correctAnswer: 3,
    explanation: 'x/4 = 8 → x = 8 × 4 = 32',
    explanationBn: 'x/4 = 8 → x = 8 × 4 = ৩২',
    difficulty: 'easy',
    points: 10,
  },
  ...
  // More Geometry Questions
  {
    ...
    questionBn: 'ত্রিভুজের কোণগুলোর সমষ্টি কত?',
    options: ['90°', '180°', '270°', '360°'],
    optionsBn: ['৯০°', '১৮০°', '২৭০°', '৩৬০°'],
    correctAnswer: 1,
    explanation: 'The sum of all interior angles of a triangle is always 180°.',
    explanationBn: 'ত্রিভুজের সব অন্তঃকোণের সমষ্টি সর্বদা ১৮০°।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: '৫ সেমি বাহুর বর্গক্ষেত্রের পরিসীমা কত?',
    options: ['10 cm', '15 cm', '20 cm', '25 cm'],
    optionsBn: ['১০ সেমি', '১৫ সেমি', '২০ সেমি', '২৫ সেমি'],
    correctAnswer: 2,
    explanation: 'Perimeter of square = 4 × side = 4 × 5 = 20 cm',
    explanationBn: 'বর্গক্ষেত্রের পরিসীমা = ৪ × বাহু = ৪ × ৫ = ২০ সেমি',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'একটি বৃত্তের ব্যাসার্ধ ৭ সেমি। এর ব্যাস কত?',
    options: ['3.5 cm', '7 cm', '14 cm', '21 cm'],
    optionsBn: ['৩.৫ সেমি', '৭ সেমি', '১৪ সেমি', '২১ সেমি'],
    correctAnswer: 2,
    explanation: 'Diameter = 2 × radius = 2 × 7 = 14 cm',
    explanationBn: 'ব্যাস = ২ × ব্যাসার্ধ = ২ × ৭ = ১৪ সেমি',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'সমকোণী ত্রিভুজে যদি একটি কোণ ৯০° এবং আরেকটি ৩০° হয়, তৃতীয় কোণ কত?',
    options: ['30°', '45°', '60°', '90°'],
    optionsBn: ['৩০°', '৪৫°', '৬০°', '৯০°'],
    correctAnswer: 2,
    explanation: 'Third angle = 180° - 90° - 30° = 60°',
    explanationBn: 'তৃতীয় কোণ = ১৮০° - ৯০° - ৩০° = ৬০°',
    difficulty: 'easy',
    points: 10,
  },
  {
  ...
  },
  {
    ...
    questionBn: 'ষড়ভুজের কতটি বাহু আছে?',
    options: ['4', '5', '6', '8'],
    optionsBn: ['৪', '৫', '৬', '৮'],
    correctAnswer: 2,
    explanation: 'A hexagon has 6 sides.',
    explanationBn: 'ষড়ভুজের ৬টি বাহু আছে।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'ভূমি ১০ সেমি এবং উচ্চতা ৬ সেমি ত্রিভুজের ক্ষেত্রফল কত?',
    options: ['16 cm²', '30 cm²', '60 cm²', '120 cm²'],
    optionsBn: ['১৬ সেমি²', '৩০ সেমি²', '৬০ সেমি²', '১২০ সেমি²'],
    correctAnswer: 1,
    explanation: 'Area = ½ × base × height = ½ × 10 × 6 = 30 cm²',
    explanationBn: 'ক্ষেত্রফল = ½ × ভূমি × উচ্চতা = ½ × ১০ × ৬ = ৩০ সেমি²',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'সমদ্বিবাহু ত্রিভুজ কী?',
    options: ['All sides equal', 'Two sides equal', 'No sides equal', 'One right angle'],
    optionsBn: ['সব বাহু সমান', 'দুই বাহু সমান', 'কোন বাহু সমান নয়', 'একটি সমকোণ'],
    correctAnswer: 1,
    explanation: 'An isosceles triangle has exactly two equal sides.',
    explanationBn: 'সমদ্বিবাহু ত্রিভুজে ঠিক দুটি সমান বাহু থাকে।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'বৃত্তের পরিধির সূত্র কী?',
    options: ['πr²', '2πr', 'πd²', 'r²'],
    correctAnswer: 1,
    explanation: 'Circumference = 2πr where r is the radius.',
    explanationBn: 'পরিধি = 2πr যেখানে r হল ব্যাসার্ধ।',
    difficulty: 'easy',
    points: 10,
  },

  // More HSC Work-Energy Questions
  {
    id: 'q-hsc-phy1-we-3',
    subjectId: 'physics-1',
    topicId: 'work-energy',
    question: 'What is kinetic energy?',
    questionBn: 'গতিশক্তি কী?',
    options: ['Energy due to position', 'Energy due to motion', 'Energy due to heat', 'Energy due to light'],
    optionsBn: ['অবস্থানজনিত শক্তি', 'গতিজনিত শক্তি', 'তাপজনিত শক্তি', 'আলোজনিত শক্তি'],
    correctAnswer: 1,
    explanation: 'Kinetic energy is the energy possessed by an object due to its motion (KE = ½mv²).',
    explanationBn: 'গতিশক্তি হল কোন বস্তুর গতির কারণে অর্জিত শক্তি (KE = ½mv²)।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: '২ kg ভরের বস্তু ৩ m/s বেগে চলছে। এর গতিশক্তি কত?',
    options: ['3 J', '6 J', '9 J', '18 J'],
    optionsBn: ['৩ J', '৬ J', '৯ J', '১৮ J'],
    correctAnswer: 2,
    explanation: 'KE = ½mv² = ½ × 2 × 3² = ½ × 2 × 9 = 9 J',
    explanationBn: 'KE = ½mv² = ½ × 2 × 3² = ½ × 2 × 9 = 9 J',
    difficulty: 'medium',
    points: 15,
  },
  {
    ...
    questionBn: 'ক্ষমতার SI একক কী?',
    options: ['Joule', 'Newton', 'Watt', 'Pascal'],
    optionsBn: ['জুল', 'নিউটন', 'ওয়াট', 'প্যাসকেল'],
    correctAnswer: 2,
    explanation: 'The SI unit of power is Watt (W). 1 W = 1 J/s.',
    explanationBn: 'ক্ষমতার SI একক ওয়াট (W)। ১ W = ১ J/s।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    subjectId: 'physics-1',
    topicId: 'work-energy',
    question: 'If a force of 10 N moves an object 5 m, what is the work done?',
    questionBn: '১০ N বল কোন বস্তুকে ৫ m সরালে কৃত কাজ কত?',
    options: ['2 J', '15 J', '50 J', '100 J'],
    optionsBn: ['২ J', '১৫ J', '৫০ J', '১০০ J'],
    correctAnswer: 2,
    explanation: 'Work = Force × Distance = 10 × 5 = 50 J',
    explanationBn: 'কাজ = বল × সরণ = ১০ × ৫ = ৫০ J',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    subjectId: 'physics-1',
    topicId: 'work-energy',
    question: 'What is potential energy at height h?',
    questionBn: 'h উচ্চতায় বিভব শক্তি কত?',
    options: ['mgh', 'mg/h', '½mv²', 'Fd'],
    correctAnswer: 0,
    explanation: 'Gravitational potential energy = mgh where m is mass, g is gravity, h is height.',
    explanationBn: 'মহাকর্ষীয় বিভব শক্তি = mgh যেখানে m হল ভর, g হল অভিকর্ষ, h হল উচ্চতা।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'বেগ দ্বিগুণ হলে গতিশক্তির কী হয়?',
    options: ['Doubles', 'Triples', 'Quadruples', 'Halves'],
    optionsBn: ['দ্বিগুণ', 'ত্রিগুণ', 'চার গুণ', 'অর্ধেক'],
    correctAnswer: 2,
    explanation: 'KE = ½mv². If v doubles, KE becomes 4 times (quadruples).',
    explanationBn: 'KE = ½mv²। বেগ দ্বিগুণ হলে, KE চার গুণ হয়।',
    difficulty: 'medium',
    points: 15,
  },
  {
    ...
    subjectId: 'physics-1',
    topicId: 'work-energy',
    question: 'What is 1 horsepower (HP) equal to?',
    questionBn: '১ হর্সপাওয়ার (HP) কত ওয়াটের সমান?',
    options: ['500 W', '746 W', '1000 W', '1200 W'],
    optionsBn: ['৫০০ W', '৭৪৬ W', '১০০০ W', '১২০০ W'],
    correctAnswer: 1,
    explanation: '1 HP = 746 Watts.',
    explanationBn: '১ HP = ৭৪৬ ওয়াট।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    subjectId: 'physics-1',
    topicId: 'work-energy',
    question: 'What is the conservation of mechanical energy?',
    questionBn: 'যান্ত্রিক শক্তির সংরক্ষণশীলতা কী?',
    options: ['Energy can be created', 'Energy can be destroyed', 'KE + PE = constant', 'Energy increases over time'],
    optionsBn: ['শক্তি সৃষ্টি করা যায়', 'শক্তি ধ্বংস করা যায়', 'KE + PE = ধ্রুবক', 'সময়ের সাথে শক্তি বাড়ে'],
    correctAnswer: 2,
    explanation: 'In an isolated system, the sum of kinetic and potential energy remains constant.',
    explanationBn: 'বিচ্ছিন্ন সিস্টেমে, গতিশক্তি এবং বিভব শক্তির সমষ্টি ধ্রুবক থাকে।',
    difficulty: 'medium',
    points: 15,
  },
  ...
  },
  {
    ...
    questionBn: 'DNA তে অ্যাডেনিনের সাথে কোন বেস জোড় বাঁধে?',
    options: ['Guanine', 'Cytosine', 'Thymine', 'Uracil'],
    optionsBn: ['গুয়ানিন', 'সাইটোসিন', 'থাইমিন', 'ইউরাসিল'],
    correctAnswer: 2,
    explanation: 'In DNA, Adenine pairs with Thymine (A-T) and Guanine pairs with Cytosine (G-C).',
    explanationBn: 'DNA তে অ্যাডেনিন থাইমিনের সাথে (A-T) এবং গুয়ানিন সাইটোসিনের সাথে (G-C) জোড় বাঁধে।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'জিন কী?',
    options: ['A type of protein', 'A segment of DNA that codes for a trait', 'A cell organelle', 'A type of RNA'],
    optionsBn: ['এক ধরনের প্রোটিন', 'DNA এর একটি অংশ যা বৈশিষ্ট্য নির্ধারণ করে', 'একটি কোষ অঙ্গাণু', 'এক ধরনের RNA'],
    correctAnswer: 1,
    explanation: 'A gene is a segment of DNA that contains instructions for making a specific protein.',
    explanationBn: 'জিন হল DNA এর একটি অংশ যা একটি নির্দিষ্ট প্রোটিন তৈরির নির্দেশনা ধারণ করে।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'DNA এর গঠন কেমন?',
    options: ['Single helix', 'Double helix', 'Triple helix', 'Straight chain'],
    optionsBn: ['একক হেলিক্স', 'ডাবল হেলিক্স', 'ট্রিপল হেলিক্স', 'সরল শৃঙ্খল'],
    correctAnswer: 1,
    explanation: 'DNA has a double helix structure, like a twisted ladder.',
    explanationBn: 'DNA এর ডাবল হেলিক্স গঠন, পেঁচানো সিঁড়ির মতো।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'মিউটেশন কী?',
    options: ['Normal cell division', 'Change in DNA sequence', 'Protein synthesis', 'Cell death'],
    optionsBn: ['স্বাভাবিক কোষ বিভাজন', 'DNA ক্রমে পরিবর্তন', 'প্রোটিন সংশ্লেষণ', 'কোষ মৃত্যু'],
    correctAnswer: 1,
    explanation: 'A mutation is a permanent change in the DNA sequence.',
    explanationBn: 'মিউটেশন হল DNA ক্রমে স্থায়ী পরিবর্তন।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'DNA থেকে রাইবোসোমে জেনেটিক তথ্য কে বহন করে?',
    options: ['tRNA', 'mRNA', 'rRNA', 'DNA'],
    correctAnswer: 1,
    explanation: 'mRNA (messenger RNA) carries genetic information from DNA to ribosomes.',
    explanationBn: 'mRNA (মেসেঞ্জার RNA) DNA থেকে রাইবোসোমে জেনেটিক তথ্য বহন করে।',
    difficulty: 'medium',
    points: 15,
  },
  ...
  // More Ecology Questions
  {
    ...
    questionBn: 'খাদ্য শৃঙ্খলে উৎপাদক কী?',
    options: ['Animals that eat plants', 'Organisms that make their own food', 'Decomposers', 'Carnivores'],
    optionsBn: ['উদ্ভিদ খায় এমন প্রাণী', 'যে জীবেরা নিজের খাদ্য তৈরি করে', 'বিয়োজক', 'মাংসাশী'],
    correctAnswer: 1,
    explanation: 'Producers (like plants) make their own food through photosynthesis.',
    explanationBn: 'উৎপাদক (যেমন উদ্ভিদ) সালোকসংশ্লেষণের মাধ্যমে নিজের খাদ্য তৈরি করে।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'তৃণভোজী কী?',
    options: ['Eats only meat', 'Eats only plants', 'Eats both plants and meat', 'Eats nothing'],
    optionsBn: ['শুধু মাংস খায়', 'শুধু উদ্ভিদ খায়', 'উদ্ভিদ এবং মাংস দুটোই খায়', 'কিছুই খায় না'],
    correctAnswer: 1,
    explanation: 'Herbivores are animals that only eat plants.',
    explanationBn: 'তৃণভোজী হল যে প্রাণীরা শুধু উদ্ভিদ খায়।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'জীববৈচিত্র্য কী?',
    options: ['Number of humans', 'Variety of life in an area', 'Size of an ecosystem', 'Amount of water'],
    optionsBn: ['মানুষের সংখ্যা', 'একটি এলাকায় জীবনের বৈচিত্র্য', 'বাস্তুতন্ত্রের আকার', 'পানির পরিমাণ'],
    correctAnswer: 1,
    explanation: 'Biodiversity refers to the variety of life forms in a particular area.',
    explanationBn: 'জীববৈচিত্র্য বলতে একটি নির্দিষ্ট এলাকায় জীবন রূপের বৈচিত্র্যকে বোঝায়।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    subjectId: 'biology',
    topicId: 'ecology',
    question: 'What percentage of energy is transferred to the next trophic level?',
    questionBn: 'পরবর্তী ট্রফিক স্তরে কত শতাংশ শক্তি স্থানান্তরিত হয়?',
    options: ['1%', '10%', '50%', '100%'],
    optionsBn: ['১%', '১০%', '৫০%', '১০০%'],
    correctAnswer: 1,
    explanation: 'Only about 10% of energy is transferred to the next trophic level (10% rule).',
    explanationBn: 'পরবর্তী ট্রফিক স্তরে প্রায় ১০% শক্তি স্থানান্তরিত হয় (১০% নিয়ম)।',
    difficulty: 'medium',
    points: 15,
  },
  {
    ...
    questionBn: 'বিয়োজকদের ভূমিকা কী?',
    options: ['Produce food', 'Hunt prey', 'Break down dead matter', 'Absorb sunlight'],
    optionsBn: ['খাদ্য উৎপাদন', 'শিকার করা', 'মৃত পদার্থ ভাঙা', 'সূর্যালোক শোষণ'],
    correctAnswer: 2,
    explanation: 'Decomposers break down dead organisms and recycle nutrients back into the ecosystem.',
    explanationBn: 'বিয়োজক মৃত জীবদের ভেঙে পুষ্টি বাস্তুতন্ত্রে ফিরিয়ে দেয়।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'খাদ্যজাল কী?',
    options: ['A single food chain', 'Multiple interconnected food chains', 'A type of plant', 'A predator'],
    optionsBn: ['একটি খাদ্য শৃঙ্খল', 'একাধিক আন্তঃসংযুক্ত খাদ্য শৃঙ্খল', 'এক ধরনের উদ্ভিদ', 'একটি শিকারী'],
    correctAnswer: 1,
    explanation: 'A food web shows multiple interconnected food chains in an ecosystem.',
    explanationBn: 'খাদ্যজাল একটি বাস্তুতন্ত্রে একাধিক আন্তঃসংযুক্ত খাদ্য শৃঙ্খল দেখায়।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'সর্বভুক কী?',
    options: ['Eats only meat', 'Eats only plants', 'Eats both plants and animals', 'Eats dead matter'],
    optionsBn: ['শুধু মাংস খায়', 'শুধু উদ্ভিদ খায়', 'উদ্ভিদ এবং প্রাণী দুটোই খায়', 'মৃত পদার্থ খায়'],
    correctAnswer: 2,
    explanation: 'Omnivores eat both plants and animals.',
    explanationBn: 'সর্বভুক উদ্ভিদ এবং প্রাণী উভয়ই খায়।',
    difficulty: 'easy',
    points: 10,
  },
  {
    ...
    questionBn: 'গ্রিনহাউস প্রভাব কী?',
    options: ['Cooling of Earth', 'Trapping of heat by atmospheric gases', 'Loss of ozone', 'Increase in oxygen'],
    optionsBn: ['পৃথিবীর শীতলতা', 'বায়ুমণ্ডলীয় গ্যাস দ্বারা তাপ আটকে রাখা', 'ওজোন ক্ষয়', 'অক্সিজেন বৃদ্ধি'],
    correctAnswer: 1,
    explanation: 'The greenhouse effect is the trapping of heat by gases like CO₂ in the atmosphere.',
    explanationBn: 'গ্রিনহাউস প্রভাব হল বায়ুমণ্ডলে CO₂ এর মতো গ্যাস দ্বারা তাপ আটকে রাখা।',
    difficulty: 'medium',
    points: 15,
  },
  {
    ...
    questionBn: 'বাসস্থান কী?',
    options: ['A type of animal', 'The place where an organism lives', 'A food source', 'A predator'],
    optionsBn: ['এক ধরনের প্রাণী', 'যেখানে একটি জীব বাস করে', 'খাদ্য উৎস', 'একটি শিকারী'],
    correctAnswer: 1,
    explanation: 'A habitat is the natural home or environment of an organism.',
    explanationBn: 'বাসস্থান হল একটি জীবের প্রাকৃতিক ঘর বা পরিবেশ।',
    difficulty: 'easy',
    points: 10,
  },
];
